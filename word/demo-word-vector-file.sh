...
# 1、对文件$TEXT_FILE进行分词，词之间以空格分隔，内容保存到文件 data/word.txt
$EXECUTOR org.apdplat.word.WordSegmenter file $TEXT_FILE  data/word.txt
# 2、对分好词的文件 data/word.txt建立词向量，将词向量保存到文件 data/vector.txt，将词汇表保存到文件 data/vocabulary.txt
# 上下文长度为
